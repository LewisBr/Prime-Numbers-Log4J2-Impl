...
public class Constants {
    ...
    /** Input Prompts **/
    public final static String INPUTRONEREADY = "## Please Input Your First Integer";
    public final static String INPUTTWOREADY = "## Please Input Your Second Integer -- First value = '{}'";
    public final static String INPUTINVALID  = "## INPUT '{}' Is Invalid, Please Try A Different Number";
